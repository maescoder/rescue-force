...
require_once __DIR__ . '/inc/db_config.php'; // uses $pdo
$UPLOAD_DIR = __DIR__ . '/uploads/';   // ensure this folder exists and is writable
$UPLOAD_URL = 'uploads/';              // relative URL used in DB/image src
